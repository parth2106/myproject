          ...
          <div class="col-sm-8 space_all">           
            ...
            <div class="col-sm-12 space_all">
                      ...
                      <ul class="nav navbar-nav">
                        <li class="active"><a href="/" class="hvr-wobble-to-top-right">HOME</a></li>
                        <li><a href="/listing" class="hvr-wobble-to-top-right">LISTING</a></li>
                        <li><a href="/sarch" class="hvr-wobble-to-top-right">SARCH FORM</a></li>
                        <li><a href="/details" class="hvr-wobble-to-top-right">DETAILS</a></li>
                        <li><a href="/contact" class="hvr-wobble-to-top-right">CONTACT</a></li>
                      </ul>
                </div>
            </div>           
          </div>
